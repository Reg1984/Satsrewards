...
BEGIN
    ...
    INSERT INTO profiles (
        ...
        email = 'teacher.satsrewards@gmail.com',
        role = 'teacher',
        name = 'Ms. Johnson',
        class_id = 'class-12A',
    ...
    INSERT INTO profiles (
        ...
        email = 'student.satsrewards@gmail.com',
        role = 'student',
        name = 'Alice Thompson',
        class_id = 'class-12A',
        school_id = v_school_id,
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            UPDATE auth.users SET
                ...
                raw_app_meta_data = '{"provider":"email","providers":["email"]}'::jsonb,
                raw_user_meta_data = '{"name":"Ms. Johnson"}'::jsonb
            WHERE email = 'teacher.satsrewards@gmail.com';
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            UPDATE auth.users SET
                ...
                raw_app_meta_data = '{"provider":"email","providers":["email"]}'::jsonb,
                raw_user_meta_data = '{"name":"Alice Thompson"}'::jsonb
            WHERE email = 'student.satsrewards@gmail.com';
    END;
    ...
    VALUES (
        ...
        jsonb_build_object(
            'teacher_email', 'teacher.satsrewards@gmail.com',
            'student_email', 'student.satsrewards@gmail.com',
            'timestamp', now(),
