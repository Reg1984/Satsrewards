/*
  ...
  1. Changes
    - Temporarily disable RLS on profiles table to allow authentication
    - Create proper RLS policies for profiles table
    - Fix authentication flow issues
    
  2. Security
    - Allow users to read their own profile
    - Allow teachers to view profiles in their class
    - Allow admins to view profiles in their school
