...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM profiles WHERE email = 'teacher.satsrewards@gmail.com') THEN
        INSERT INTO profiles (id, email, role, name, class_id, educational_credits)
        VALUES 
            ('00000000-0000-0000-0000-000000000001', 'teacher.satsrewards@gmail.com', 'teacher', 'Test Teacher', '10A', 0);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM profiles WHERE email = 'student.satsrewards@gmail.com') THEN
        INSERT INTO profiles (id, email, role, name, class_id, educational_credits)
        VALUES 
            ('00000000-0000-0000-0000-000000000002', 'student.satsrewards@gmail.com', 'student', 'Test Student', '10A', 500);
    END IF;
END $$;